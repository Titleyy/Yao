...
/**
 *  \brief Calculates the 32-bit fractional product of two 32-bit fractional numbers, right
...
/**
 *  \brief Calculates the 32-bit fractional product of two 16-bit fractional numbers, right
 *  shifted and saturated.
 *
