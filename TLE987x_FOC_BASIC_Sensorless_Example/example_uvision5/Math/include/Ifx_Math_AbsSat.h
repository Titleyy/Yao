...
/**
 *  \brief Calculates the 16-bit absolute value of the 16-bit fractional input with
 *  saturation.
 *
 *  This function calculates the 16-bit absolute value of the 16-bit fractional
 *  number x. The result is limited between IFX_MATH_FRACT16_MIN and
 *  IFX_MATH_FRACT16_MAX and returned.
 *
 ...
 *
 *  This function calculate the 32-bit absolute value of the 32-bit fractional
 *  number x. The result is limited between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX and returned.
 *
