 ...
 *  IFX_MATH_FRACT16_MAX, subracts the result of the product from the 16-bit
 *  fractional number x and returns the result, saturated between
...
/**
 *  \brief Calculates the 32-bit fractional product of two 32-bit fractional numbers,
 *  shifted and saturated.
 *
 ...
 *  IFX_MATH_FRACT32_MAX, subracts the result of the product from the 32-bit
 *  fractional number x and returns the result, saturated between
...
/**
 *  \brief Calculates the 32-bit fractional product of two 16-bit fractional numbers,
 *  shifted and saturated.
 *
 *  This function calculates the 32-bit fractional product of two 16-bit fractional
 *  numbers, y and z, shifted by n, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX, subtracts the result of the product from the 16-bit
 *  fractional number x and returns the result, saturated between
 *  IFX_MATH_FRACT32_MIN and IFX_MATH_FRACT32_MAX.
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
