...
/**
 *  \brief Returns the 16-bit negative value of the 16-bit fractional number x without
...
/**
 *  \brief Returns the 32-bit negative value of the 32-bit fractional number x without
 *  saturation and any overflow detection.
 *
