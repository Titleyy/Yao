 ...
 *  \return Shift value
 */
static inline int8_t Ifx_Math_DivShLR_ShiftDiv(Ifx_Math_FractQFormat typeX, Ifx_Math_FractQFormat typeY,
 ...
 *
 *  \param [in] n Number of bits to shift the division result, between -16 and 16. Positive n
 * indicates left shift, negative n indicates right shift
 *
 *  \return 16-bit fractional number with the format Q(a-b+n)
 */
static inline Ifx_Math_Fract16 Ifx_Math_DivShLR_F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, int8_t n)
{
 ...
 */
static inline Ifx_Math_Fract64 Ifx_Math_DivShLR_p_F64_F32F32(Ifx_Math_Fract32 x, Ifx_Math_Fract32 y, int8_t n)
{
    /* Stores the return value */
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_DivShLR_F32(Ifx_Math_Fract32 x, Ifx_Math_Fract32 y, int8_t n)
{
