...
/**
 *  \brief Returns the 16-bit negative value of the 16-bit input, limited between
 *  FRACT16_MIN and FRACT16_MAX.
 *
...
/**
 *  \brief Returns the 32-bit negative value of the 32-bit input limited between
 *  FRACT32_MIN and FRACT32_MAX.
 *
