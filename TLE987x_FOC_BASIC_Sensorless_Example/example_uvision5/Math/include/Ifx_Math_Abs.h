 ...
 *  number x. The result is returned without saturation and any overflow detection.
 *
 ...
 *
 *  This function calculates the 32-bit absolute value of the 32-bit fractional
 *  number x. The result is returned without saturation and any overflow detection.
 *
