 ...
 *  numbers, x and y, shifted right by 15, without saturation and overflow
 *  detection.
 *
 ...
 *
 *  This function calculates the 32-bit the fractional product of two 32-bit
 *  fractional numbers, x and y, shifted right by 31, without saturation and
 *  overflow detection.
 *
...
/**
 *  \brief Calculate the 32-bit fractional product of two 16-bit fractional numbers,,
 *  shifted left by 1.
 *
 *  This function calculates the 32-bit fractional product of two 16-bit fractional
 *  numbers, x and y, shifted left by 1, without saturation and overflow detection.
 *
 *  \param [in] x 16-bit fractional number with the format Qa
 *
 *  \param [in] y 16-bit fractional number with the format Qb
