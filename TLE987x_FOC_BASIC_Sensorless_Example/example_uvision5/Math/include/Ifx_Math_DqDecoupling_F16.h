 ...
 */
static inline void Ifx_Math_DqDecoupling_F16_init(Ifx_Math_DqDecoupling_F16* self)
{
 ...
 */
static inline void Ifx_Math_DqDecoupling_F16_setInductanceQ(Ifx_Math_DqDecoupling_F16* self, Ifx_Math_Fract16
                                                            inductanceQ)
{
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_DqDecoupling_F16_getInductanceQ(Ifx_Math_DqDecoupling_F16* self)
{
 ...
 */
static inline void Ifx_Math_DqDecoupling_F16_setInductanceD(Ifx_Math_DqDecoupling_F16* self, Ifx_Math_Fract16
                                                            inductanceD)
{
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_DqDecoupling_F16_getInductanceD(Ifx_Math_DqDecoupling_F16* self)
{
 ...
 *
 *  This function calculates compensation voltage \f$U_{dq,comp}\f$ which
 *  compensates the cross-coupling effect between the d and q axis of a permanent
 *  magnet synchronous motor. The calculated voltages can be used as a feed forward
 *  in a field oriented control scheme to improve the dynamics of the current
 *  control.
 *
 *  \param [inout] self Reference to structure that contains instance data members
 *
 ...
 */
static inline Ifx_Math_CmpFract16 Ifx_Math_DqDecoupling_F16_execute(Ifx_Math_DqDecoupling_F16* self,
                                                                    Ifx_Math_CmpFract16 currentsDQ, Ifx_Math_Fract16
                                                                    speed)
{
...
#endif /*IFX_MATH_DQDECOUPLING_F16_H*/
