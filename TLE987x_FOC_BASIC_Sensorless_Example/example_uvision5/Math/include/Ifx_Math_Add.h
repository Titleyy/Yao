 ...
 *
 *  This functions calculates the 16-bit fractional sum of two 16-bit fractional
 *  numbers, x and y, without saturation and any overflow detection.
 *
 ...
 *
 *  This function calculates the 32-bit fractional sum of two 16-bit fractional
 *  numbers, x and y, without saturation and any overflow detection.
 *
 *  \param [in] x The first operand of the addition
 *
