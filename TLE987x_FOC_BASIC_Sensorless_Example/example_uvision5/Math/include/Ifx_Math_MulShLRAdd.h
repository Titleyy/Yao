...
/**
 *  \brief Calculate the 16-bit fractional product of two fractional numbers, y and z,
 *  shifted by n, and add to the 16-bit fractional number x, without saturation and
 *  overflow detection.
 *
...
/**
 *  \brief Calculate the 32-bit fractional product of two 32-bit fractional numbers y and
 *  z, shifted by n, and add to the 32-bit fractional number x, without saturation
...
/**
 *  \brief Calculate the 32-bit fractional product of two 16-bit fractional numbers y and
 *  z, shifted by n, and add to the 16-bit fractional number x, without saturation
 *  and overflow detection.
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
 *
