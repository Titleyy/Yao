 ...
 *  The division is not protected from division by zero.
 *
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_DivShLSatNZ_F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, uint8_t n)
{
