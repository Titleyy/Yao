...
/**
 *  \brief Return the 16-bit fractional difference of two 16-bit fractional numbers, x and
 *  y, without saturation and any overflow detection.
 *
...
/**
 *  \brief Return the 32-bit fractional difference of two 32-bit fractional numbers, x and
 *  y, without saturation and any overflow detection.
 *
 *  \param [in] x The first operand of the subtraction
 *
...
/**
 *  \brief Return the 32-bit fractional difference of two 16-bit fractional numbers, x and
 *  y, without saturation and any overflow detection.
 *
 *  \param [in] x The first operand of the subtraction
 *
