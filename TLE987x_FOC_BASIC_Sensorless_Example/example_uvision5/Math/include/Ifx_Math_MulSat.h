 ...
 *  y, shifted right by 15, saturated between IFX_MATH_FRACT16_MIN and
...
/**
 *  \brief Calculates the 32-bit fractional product of 32-bit fractional numbers, x and y,
 *  shifted right by 31, saturated between IFX_MATH_FRACT32_MIN and
