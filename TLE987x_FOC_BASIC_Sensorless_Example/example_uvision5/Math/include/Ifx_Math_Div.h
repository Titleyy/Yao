 ...
 *  shifted left by 15 without saturation and overflow detection. The division is
 *  protected from division by zero by returning IFX_MATH_FRACT16_MAX if x &gt;= 0
 *  and IFX_MATH_FRACT16_MIN if x &lt; 0.
 *
 ...
 *  fractional inputs, x and y, where x is the numerator and y the denominator,
 *  shifted left by 31 without saturation and overflow detection. The division is
