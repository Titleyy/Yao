 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_AccelLimit_F16_p_limit(Ifx_Math_Fract32 input, Ifx_Math_Fract32 upperLimit,
 ...
 *
 */
static inline void Ifx_Math_AccelLimit_F16_p_calcZeroRegion(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32 input);
 ...
 *
 */
static inline void Ifx_Math_AccelLimit_F16_p_calcPosRegion(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32 input);
 ...
 *
 */
static inline void Ifx_Math_AccelLimit_F16_p_calcNegRegion(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32 input);
...
Ifx_Math_Fract16 Ifx_Math_AccelLimit_F16_execute(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract16 input)
{
    ...
    if (self->p_speedStepPreviousValue > 0)
    {
        ...
        Ifx_Math_AccelLimit_F16_p_calcPosRegion(self, input32);
    }
    else if (self->p_speedStepPreviousValue < 0)
    {
        /* Update previous value if in -ve region */
        Ifx_Math_AccelLimit_F16_p_calcNegRegion(self, input32);
    }
    else
    {
        /* Update previous value if in zero region */
        Ifx_Math_AccelLimit_F16_p_calcZeroRegion(self, input32);
    }
...
static inline void Ifx_Math_AccelLimit_F16_p_calcPosRegion(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32 input)
{
    ...
    self->p_speedStepPreviousValue = Ifx_Math_AccelLimit_F16_p_limit(input, upNew, downNew);
}
