...
#define IFX_MATH_CARTTOPOLAR_SHIFT (15 - IFX_MATH_MOTORCONTROLMATH_F16_CFG_CARTTOPOLAR_LUT_SIZE)
...
/* *INDENT-ON* */
__WEAK Ifx_Math_PolarFract16 Ifx_Math_CartToPolar_F16(Ifx_Math_CmpFract16 cartesian)
{
