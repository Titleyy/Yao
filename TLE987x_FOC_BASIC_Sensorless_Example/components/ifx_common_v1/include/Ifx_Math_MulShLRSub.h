 ...
 *  z, shifted by n, and subtract it from the 16-bit fractional number x, without
 ...
 *  z, shifted by n, and subtract it from the 32-bit fractional number x, without
 *  saturation and overflow detection.
 *
...
/**
 *  \brief Calculates the 32-bit fractional product of two 16-bit fractional numbers, y and
 *  z, shifted by n, and subtract it from the 16-bit fractional number x, without
 *  saturation and overflow detection.
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
