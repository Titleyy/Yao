...
typedef enum Ifx_ComponentID_LibraryID
{
    ...
    Ifx_ComponentID_LibraryID_frwHardwareAbstraction   = 6, /**<Framework Hardware Abstraction*/
    Ifx_ComponentID_LibraryID_framework                = 7, /**<Framework Library*/
    Ifx_ComponentID_LibraryID_diagHardwareAbstraction  = 8, /**<Diagnostic Hardware Abstraction*/
    Ifx_ComponentID_LibraryID_comHardwareAbstraction   = 9, /**<Communication Hardware Abstraction*/
