...
/**
 * \file Ifx_Math_SpeedPreControl_F16.h
 * \brief This module calculates the reference q-axis current based on the reference speed and motor parameters.
 */

#ifndef IFX_MATH_SPEEDPRECONTROL_F16_H
#define IFX_MATH_SPEEDPRECONTROL_F16_H
#include "Ifx_Math.h"

/**
 * Contains the static configuration parameters
 */
typedef struct Ifx_Math_SpeedPreControl_F16_StaticConfig
{
    /**
...
} Ifx_Math_SpeedPreControl_F16_StaticConfig;

/**
 * \brief Data structure that stores all data of module instance.
 */
typedef struct Ifx_Math_SpeedPreControl_F16
{
    /**
     * Static configuration of the speed pre control
     */
    Ifx_Math_SpeedPreControl_F16_StaticConfig p_staticConfiguration;
 ...
 */
void Ifx_Math_SpeedPreControl_F16_init(Ifx_Math_SpeedPreControl_F16* self, Ifx_Math_SpeedPreControl_F16_StaticConfig
                                       staticConfiguration);
 ...
 */
static inline void Ifx_Math_SpeedPreControl_F16_setInverseTorqueConstant(Ifx_Math_SpeedPreControl_F16* self,
                                                                         Ifx_Math_Fract16
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_SpeedPreControl_F16_getInverseTorqueConstant(
    Ifx_Math_SpeedPreControl_F16* self)
{
 ...
 *
 *  This function calculates quadrature current. The calculated current can be used
 *  as a feed forward in a field oriented control scheme to improve the dynamics of
 *  the speed control.
 *
 *  \param [inout] self Reference to structure that contains instance data members
 *
 ...
 */
Ifx_Math_Fract16 Ifx_Math_SpeedPreControl_F16_execute(Ifx_Math_SpeedPreControl_F16* self, Ifx_Math_Fract16 speed);
 ...
 */
static inline void Ifx_Math_SpeedPreControl_F16_setPreviousSpeed(Ifx_Math_SpeedPreControl_F16* self, Ifx_Math_Fract16
                                                                 previousSpeed)
{
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_SpeedPreControl_F16_getPreviousSpeed(Ifx_Math_SpeedPreControl_F16* self)
{
    return self->p_previousSpeed;
}


#endif /*IFX_MATH_SPEEDPRECONTROL_F16_H*/
