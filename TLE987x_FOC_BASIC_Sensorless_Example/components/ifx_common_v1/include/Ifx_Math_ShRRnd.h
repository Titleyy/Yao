 ...
 *
 *  This function returns the result of the corresponding division of the 16-bit
 *  input parameter x by two powered by shift value n, rounded up to the nearest
 *  integer. For example: 3/4 = 1, 5/4 = 1, 7/4 = 2. In case that the fractional
 *  part equals 0.5, the result is rounded up. For example: 1/2 = 1, 3/2 = 2, -1/2 =
 *  0.
 *
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_ShRRnd_F16(Ifx_Math_Fract16 x, uint8_t n)
{
 ...
 *
 *  This function returns the result of the corresponding division of the 32-bit
 *  input parameter x by two powered by shift value n, rounded up to the nearest
 *  integer. For example: 3/4 = 1, 5/4 = 1, 7/4 = 2. In case that the fractional
 *  part equals 0.5, the result is rounded up. For example: 1/2 = 1, 3/2 = 2, -1/2 =
 *  0.
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_ShRRnd_F32(Ifx_Math_Fract32 x, uint8_t n)
{
