...
/**
 *  \brief Calculates the 16-bit fractional sum of two 16-bit fractional numbers, with
 *  saturation.
 *
 *  This function calculates the 16-bit fractional sum of two 16-bit fractional
 *  numbers, x and y. The result is limited between IFX_MATH_FRACT16_MIN and
...
/**
 *  \brief Calculates the 32-bit fractional sum of two 32-bit fractional numbers, with
 *  saturation.
 *
 *  This function calculates the 32-bit fractional sum of two 32-bit fractional
 *  numbers, x and y. The result is limited between IFX_MATH_FRACT32_MIN and
