 ...
 *
 *  This function calculates the sinus and cosinus value of a 32-bit angle value, in
 *  the range \f$[0, 2*\pi]\f$, normalized by\f$2*\pi\f$. The output resolution is
 *  configurable by controlling the sine lookup table size. The size of the lookup
 *  table is given by IFX_MATH_TRIGONOMETRIC_F16_CFG_SIN_LUT_SIZE.
 *  The valid configuration set is: IFX_MATH_TRIGONOMETRIC_F16_CFG_SIN_LUT_SIZE =
 ...
 */
static inline Ifx_Math_SinCos_Type Ifx_Math_SinCos_F16(uint32_t x)
{
