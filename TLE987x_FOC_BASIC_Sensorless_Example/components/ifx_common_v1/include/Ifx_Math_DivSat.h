...
/**
 *  Calculate the 16-bit fractional quotient of two fractional numbers, x and y,
 *  where x is the numerator and y the denominator, shifted left by 15, saturated
...
/**
 *  Calculate the 32-bit fractional quotient between x and y, where x is the
 *  numerator and y the denominator, shifted left by 31, saturated between
