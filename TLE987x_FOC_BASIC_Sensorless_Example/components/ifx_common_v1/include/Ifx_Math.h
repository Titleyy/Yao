...
{
    /**
     * Flag needed for DC-Link current measurements, indicates whether the second current trigger is measuring the sum
     * of two phase currents or only one phase current.
     */
 ...
 */
typedef int32_t Ifx_Math_Fract32;

/**
 * 64-bit signed fractional type
 */
typedef int64_t Ifx_Math_Fract64;
