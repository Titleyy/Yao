 ...
 *  numbers, x and y, left shifted by n, without saturation and overflow detection.
 *
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_MulShL_F32_F16F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, uint8_t n)
{
