...
#ifndef IFX_MATH_RATELIMIT_F16_H
#define IFX_MATH_RATELIMIT_F16_H
#include "Ifx_Math.h"

/**
 * \brief Data structure that stores all data of module instance.
 */
typedef struct Ifx_Math_RateLimit_F16
{
    /**
 ...
 */
static inline void Ifx_Math_RateLimit_F16_init(Ifx_Math_RateLimit_F16* self)
{
 ...
 *
 *  This function implements the 16-bit version of the rate limiter. It returns the
 *  input value saturated between \f$ previousValue + upRate \f$ and \f$
 *  previousValue - downRate \f$, and updates the state variable (stores the new
 ...
 */
Ifx_Math_Fract16 Ifx_Math_RateLimit_F16_execute(Ifx_Math_RateLimit_F16* self, Ifx_Math_Fract16 input);
 ...
 */
static inline void Ifx_Math_RateLimit_F16_setUpRate(Ifx_Math_RateLimit_F16* self, Ifx_Math_Fract16 upRate)
{
 ...
 *  \return Rising rate
 */
static inline Ifx_Math_Fract16 Ifx_Math_RateLimit_F16_getUpRate(Ifx_Math_RateLimit_F16* self)
{
 ...
 */
static inline void Ifx_Math_RateLimit_F16_setDownRate(Ifx_Math_RateLimit_F16* self, Ifx_Math_Fract16 downRate)
{
 ...
 *  \return Falling rate
 */
static inline Ifx_Math_Fract16 Ifx_Math_RateLimit_F16_getDownRate(Ifx_Math_RateLimit_F16* self)
{
 ...
 */
static inline void Ifx_Math_RateLimit_F16_setPreviousValue(Ifx_Math_RateLimit_F16* self, Ifx_Math_Fract16
                                                           previousValue)
{
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_RateLimit_F16_getPreviousValue(Ifx_Math_RateLimit_F16* self)
{
    return self->p_previousValue;
}


#endif /*IFX_MATH_RATELIMIT_F16_H*/
