...
/**
 *  \brief Return the 16-bit saturated fractional difference of two 16-bit fractional
 *  numbers.
 *
 *  Return the 16-bit fractional difference of two 16-bit fractional numbers, x and
 *  y. The result is limited between IFX_MATH_FRACT16_MIN and IFX_MATH_FRACT16_MAX.
 *
...
/**
 *  \brief Return the 32-bit saturated fractional difference of two 32-bit fractional
 *  numbers.
 *
 *  Return the 32-bit fractional difference of two 32-bit fractional numbers, x and
 *  y. The result is limited between IFX_MATH_FRACT32_MIN and IFX_MATH_FRACT32_MAX.
 *
 *  \param [in] x The first operand of the subtraction
 *
 *  \param [in] y The second operand of the subtraction
