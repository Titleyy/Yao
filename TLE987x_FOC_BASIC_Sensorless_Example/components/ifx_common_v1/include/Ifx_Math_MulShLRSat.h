...
/**
 *  \brief Calculates the 16-bit fractional product of two 16-bit fractional numbers, x and
 *  y, shifted by n, saturated between IFX_MATH_FRACT16_MIN and
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_MulShLRSat_F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, int8_t n)
{
...
/**
 *  \brief Calculates the 32-bit fractional product of two 32-bit fractional numbers, x and
 *  y, shifted by n, saturated between IFX_MATH_FRACT32_MIN and
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_MulShLRSat_F32(Ifx_Math_Fract32 x, Ifx_Math_Fract32 y, int8_t n)
{
...
/**
 *  \brief Calculate the 32-bit fractional product of two 16-bit fractional numbers, x and
 *  y, shifted by n, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX.
 *
 *  \param [in] x 16-bit fractional number with the format Qa
 ...
 *  \return 32-bit fractional number with the format Q(a+b-n)
 */
static inline Ifx_Math_Fract32 Ifx_Math_MulShLRSat_F32_F16F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, int8_t n)
{
