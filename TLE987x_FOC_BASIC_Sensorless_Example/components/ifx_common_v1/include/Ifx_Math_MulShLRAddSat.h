...
/**
 *  \brief Calculates the 16-bit fractional product of two 16-bit fractional numbers, y and
 *  z, shifted by n, and saturated.
 *
 *  This function calculates the 16-bit fractional product of two 16-bit fractional
 *  numbers, y and z, shifted by n, saturated between IFX_MATH_FRACT16_MIN and
 *  IFX_MATH_FRACT16_MAX, adds the 16-bit fractional input x to the result of the
 *  product and returns the result, saturated between IFX_MATH_FRACT16_MIN and
...
/**
 *  \brief Calculates the 32-bit fractional product of two 32-bit fractional numbers, y and
 *  z, shifted by n, and saturated.
 *
 *  This function calculates the 32-bit fractional product of two 32-bit fractional
 *  numbers, y and z, shifted by n, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX, adds the 32-bit fractional number x to the result of the
 *  product and returns the result, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX.
 *
...
/**
 *  \brief Calculates the 32bit fractional product of two 16-bit fractional numbers, y and
 *  z, shifted by n, and saturated.
 *
 *  This function calculates the 32bit fractional product of two 16-bit fractional
 *  numbers, y and z, shifted by n, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX, adds the 16-bit fractional number x to the result of the
 *  product and returns the result, saturated between IFX_MATH_FRACT32_MIN and
 *  IFX_MATH_FRACT32_MAX.
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
