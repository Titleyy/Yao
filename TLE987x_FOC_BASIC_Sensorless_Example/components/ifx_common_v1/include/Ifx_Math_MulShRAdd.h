 ...
 *  right shifted by n, and add to the 16-bit fractional number x, without
 ...
 *  z, right shifted by n, and add to the 32-bit fractional number x, without
 *  saturation and overflow detection.
 *
 ...
 *  z, right shifted by n, and add to the 16-bit fractional number x, without
 *  saturation and overflow detection.
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
 *
