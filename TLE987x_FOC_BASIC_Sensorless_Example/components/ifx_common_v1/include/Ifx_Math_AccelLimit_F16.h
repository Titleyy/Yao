...
/**
 * \file Ifx_Math_AccelLimit_F16.h
...
#ifndef IFX_MATH_ACCELLIMIT_F16_H
#define IFX_MATH_ACCELLIMIT_F16_H
#include "Ifx_Math.h"
 ...
 */
typedef struct Ifx_Math_AccelLimit_F16
{
    /**
 ...
 */
static inline void Ifx_Math_AccelLimit_F16_init(Ifx_Math_AccelLimit_F16* self)
{
 ...
 *
 *  This API implements the 16-bit version of the Acceleration limiter. It returns
 *  the input value saturated between (speedStepPreviousValue + speedStepUpLim) and
 *  (speedStepPreviousValue - speedStepDownLim), and updates the state variable
 *  (stores the new output in the speedStepPreviousValue variable).
 *
 *  \param [inout] self Reference to structure that contains instance data members
 *
 ...
 */
Ifx_Math_Fract16 Ifx_Math_AccelLimit_F16_execute(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract16 input);
 ...
 */
static inline void Ifx_Math_AccelLimit_F16_setSpeedStepUpLimit(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32
                                                               stepUpQ30)
{
 ...
 *  \return Rising rate
 */
static inline Ifx_Math_Fract32 Ifx_Math_AccelLimit_F16_getSpeedStepUpLimit(Ifx_Math_AccelLimit_F16* self)
{
 ...
 */
static inline void Ifx_Math_AccelLimit_F16_setSpeedStepDownLimit(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract32
                                                                 stepDownQ30)
{
 ...
 *  \return Falling rate
 */
static inline Ifx_Math_Fract32 Ifx_Math_AccelLimit_F16_getSpeedStepDownLimit(Ifx_Math_AccelLimit_F16* self)
{
 ...
 */
static inline void Ifx_Math_AccelLimit_F16_setSpeedStepPreviousValue(Ifx_Math_AccelLimit_F16* self, Ifx_Math_Fract16
                                                                     previousValue)
{
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_AccelLimit_F16_getSpeedStepPreviousValue(Ifx_Math_AccelLimit_F16* self)
{
    return (Ifx_Math_Fract16)Ifx_Math_ShR_F32(self->p_speedStepPreviousValue, 15);
}


#endif /*IFX_MATH_ACCELLIMIT_F16_H*/
